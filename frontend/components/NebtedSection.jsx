...
function NebtedSection() {
  return (
    <div className="px-[10px] md:px-[25px] lg:px-[100px] m-auto mt-8 lg:mt-10 ">
        ...
        2023 NEBTED NIGHT ANSWERS RESOURCES
        </h1>
        ...
        <Gaurantee information={`100% Refund Of Your Money If 2023 NABTEB  Questions & Answers Is Not Delivered/Send To You Midnight Before Exam Time.
